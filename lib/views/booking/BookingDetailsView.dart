...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('الحجز ل ${booking.guestName}'),
//         actions: [
//           IconButton(
...
//     final date = DateFormat('y/MM/dd – HH:mm').format(DateTime.now());
...
//           ),
//           pw.Bullet(text: "الاسم: ${booking.guestName}"),
//           pw.Bullet(text: "الهاتف: ${booking.guestPhone}"),
//           pw.Bullet(text: "البريد: ${booking.guestEmail}"),
...
//           pw.Bullet(
//             text:
//                 "تاريخ الدخول: ${DateFormat.yMMMd().format(booking.checkInDate)}",
//           ),
//           pw.Bullet(
//             text:
//                 "تاريخ الخروج: ${DateFormat.yMMMd().format(booking.checkOutDate)}",
//           ),
//           pw.Bullet(text: "عدد الليالي: ${booking.nights}"),
//           pw.Bullet(text: "عدد الضيوف: ${booking.numberOfGuests}"),
//           pw.Bullet(text: "نوع الحجز: ${booking.bookingType.name}"),
//           pw.SizedBox(height: 15),
...
//             style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold),
//           ),
//           pw.Bullet(text: "السعر الكلي: ${booking.totalPrice} ريال"),
//           pw.Bullet(text: "المدفوع: ${booking.amountPaid} ريال"),
//           pw.Bullet(text: "الباقي: ${booking.remainingBalance} ريال"),
//           pw.Bullet(text: "طريقة الدفع: ${booking.paymentMethod.name}"),
//           pw.SizedBox(height: 15),
...
//             pw.Text("لا يوجد مرفقات")
//           else
//             pw.Column(
//               crossAxisAlignment: pw.CrossAxisAlignment.start,
//               children: booking.attachments
...
//     // عرض PDF في عارض الطباعة/المشاركة
